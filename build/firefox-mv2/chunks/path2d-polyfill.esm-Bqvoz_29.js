function F(n, a, r) {
  for (var t = 0, o = a.length, l; t < o; t++) (l || !(t in a)) && (l || (l = Array.prototype.slice.call(a, 0, t)), l[t] = a[t]);
  return n.concat(l || Array.prototype.slice.call(a));
}
var q = { a: 7, c: 6, h: 1, l: 2, m: 2, q: 4, s: 4, t: 2, v: 1, z: 0 }, Z = /([astvzqmhlc])([^astvzqmhlc]*)/gi, _ = /-?[0-9]*\.?[0-9]+(?:e[-+]?\d+)?/gi;
function U(n) {
  var a = n.match(_);
...
function j(n) {
  ...
  return r[0] !== "M" && r[0] !== "m" || r.replace(Z, function(t, o, l) {
    ...
    if (u === "m" && s.length > 2 && (a.push(F([h], s.splice(0, 2))), u = "l", h = h === "m" ? "l" : "L"), s.length < q[u]) return "";
    for (a.push(F([h], s.splice(0, q[u]))); s.length >= q[u] && s.length && q[u]; ) a.push(F([h], s.splice(0, q[u])));
    return "";
  }), a;
}
function B(n, a) {
...
function N(n, a) {
  var r = 0, t = 0, o, l, s, u, h, v, P, C, I, A, S, G, D, p, f, z, d, b, k, E, Q, R = null, g = null, y = null, T = null, M = null, m = null;
  n.beginPath();
  for (var i = 0; i < a.length; ++i) {
    b = a[i][0], b !== "S" && b !== "s" && b !== "C" && b !== "c" && (R = null, g = null), b !== "T" && b !== "t" && b !== "Q" && b !== "q" && (y = null, T = null);
    var e = void 0;
    switch (b) {
      case "m":
      case "M":
      ...
      case "a":
      case "A":
        if (e = a[i], m === null) throw new Error("This should never happen");
        b === "a" ? (r += e[6], t += e[7]) : (r = e[6], t = e[7]), p = e[1], f = e[2], P = e[3] * Math.PI / 180, s = !!e[4], u = !!e[5], h = { x: r, y: t }, v = { x: (m.x - h.x) / 2, y: (m.y - h.y) / 2 }, B(v, -P), C = v.x * v.x / (p * p) + v.y * v.y / (f * f), C > 1 && (C = Math.sqrt(C), p *= C, f *= C), k = { x: p * v.y / f, y: -(f * v.x) / p }, I = p * p * f * f, A = p * p * v.y * v.y + f * f * v.x * v.x, u !== s ? H(k, Math.sqrt((I - A) / A) || 0) : H(k, -Math.sqrt((I - A) / A) || 0), l = Math.atan2((v.y - k.y) / f, (v.x - k.x) / p), o = Math.atan2(-(v.y + k.y) / f, -(v.x + k.x) / p), B(k, P), J(k, (h.x + m.x) / 2, (h.y + m.y) / 2), n.save(), n.translate(k.x, k.y), n.rotate(P), n.scale(p, f), n.arc(0, 0, 1, l, o, !u), n.restore();
        break;
      case "C":
        e = a[i], R = e[3], g = e[4], r = e[5], t = e[6], n.bezierCurveTo(e[1], e[2], R, g, r, t);
        break;
      case "c":
        e = a[i], n.bezierCurveTo(e[1] + r, e[2] + t, e[3] + r, e[4] + t, e[5] + r, e[6] + t), R = e[3] + r, g = e[4] + t, r += e[5], t += e[6];
        break;
      case "S":
        e = a[i], (R === null || g === null) && (R = r, g = t), n.bezierCurveTo(2 * r - R, 2 * t - g, e[1], e[2], e[3], e[4]), R = e[1], g = e[2], r = e[3], t = e[4];
        break;
      case "s":
        e = a[i], (R === null || g === null) && (R = r, g = t), n.bezierCurveTo(2 * r - R, 2 * t - g, e[1] + r, e[2] + t, e[3] + r, e[4] + t), R = e[1] + r, g = e[2] + t, r += e[3], t += e[4];
        break;
      case "Q":
...
function V(n, a, r, t, o) {
  ...
  if (o === void 0 && (o = 0), typeof o == "number" && (o = [o]), Array.isArray(o)) {
    if (o.length === 0 || o.length > 4) throw new RangeError("Failed to execute 'roundRect' on '".concat(this.constructor.name, "': ").concat(o.length, " radii provided. Between one and four radii are necessary."));
    o.forEach(function(C) {
      if (C < 0) throw new RangeError("Failed to execute 'roundRect' on '".concat(l.constructor.name, "': Radius value ").concat(C, " is negative."));
    });
  } else return;
  if (o.length === 1 && o[0] === 0) return this.rect(n, a, r, t);
